.. Gaussian-2-Blender documentation master file, created by
   sphinx-quickstart on Sun Feb  9 22:51:38 2025.
   You can adapt this file completely to your liking, but it should at least
   contain the root `toctree` directive.

Welcome to Gaussian-2-Blender's documentation!
==============================================
**Gaussian-2-Blender** is an API to convert .com input files from Gaussian and .xyz files from various sources
