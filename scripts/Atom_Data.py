class Ionic:
    ...
    def __init__(self, charge=0, coordination="", spin="", radius=0.0):
        self.charge = charge
...
IonicRadii = { #element symbols, their covalent radii & their RGBA color values
    ...
    "Cr": [Ionic(2,VI,LowSpin,0.73),Ionic(2,"",HighSpin,0.8),Ionic(3,VI,"",0.615),Ionic(4,IV,"",0.41),Ionic(4,VI,"",0.55),
            Ionic(5,IV,"",0.345),Ionic(5,VI,"",0.49),Ionic(5,VIII,"",0.57),Ionic(6,IV,"",0.26),Ionic(6,VI,"",0.44)],
    "Co": [Ionic(2,IV,HighSpin,0.58),Ionic(2,V,"",0.67),Ionic(2,VI,LowSpin,0.65),Ionic(2,"",HighSpin,0.745),Ionic(2,VIII,"",0.9),
            Ionic(3,VI,LowSpin,0.545),Ionic(3,"",HighSpin,0.61),Ionic(4,IV,"",0.4),Ionic(4,VI,HighSpin,0.53)],
    "Cn": [Ionic()],
    "Cu": [Ionic(1,II,"",0.46),Ionic(1,IV,"",0.6),Ionic(1,VI,"",0.77),Ionic(2,IV,"",0.57),Ionic(2,IVSQ,"",0.57),Ionic(2,V,"",0.65),
            Ionic(2,VI,"",0.73),Ionic(3,VI,LowSpin,0.54),Ionic(1,II,"",-0.1)],
    ...
    "Fe": [Ionic(2,IV,HighSpin,0.63),Ionic(2,IVSQ,HighSpin,0.64),Ionic(2,VI,LowSpin,0.61),Ionic(2,"",HighSpin,0.78),
            Ionic(2,VIII,HighSpin,0.92),Ionic(3,IV,HighSpin,0.49),Ionic(3,V,"",0.58),Ionic(3,VI,LowSpin,0.55),
            Ionic(3,"",HighSpin,0.645),Ionic(3,VIII,HighSpin,0.78),Ionic(4,VI,"",0.585),Ionic(6,IV,"",0.25)],
    "Kr": [Ionic()],
    ...
    "Mn": [Ionic(2,IV,HighSpin,0.66),Ionic(2,V,HighSpin,0.75),Ionic(2,VI,HighSpin,0.83),Ionic(2,"",LowSpin,0.67),
            Ionic(2,VII,HighSpin,0.9),Ionic(2,VIII,"",0.96),Ionic(3,V,"",0.58),Ionic(3,VI,LowSpin,0.58),Ionic(3,"",HighSpin,0.645),
    ...
    "Ni": [Ionic(2,IV,"",0.55),Ionic(2,IVSQ,"",0.49),Ionic(2,V,"",0.63),Ionic(2,VI,"",0.69),Ionic(3,VI,LowSpin,0.56),
            Ionic(3,"",HighSpin,0.6),Ionic(4,VI,LowSpin,0.48)],
    "Nh": [Ionic()],
